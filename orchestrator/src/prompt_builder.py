...
def build_synthesis_messages(
    ...
    system_prompt = (
        ...
        "- Do NOT blindly combine all actions from both sides. That is additive, not synthesis.\n"
        ...
        "- In BULL_TREND or SIDEWAYS: normal aggression, deploy cash opportunistically.\n"
        "- NEVER deploy more than 50% of available cash in a single HIGH_VOLATILITY cycle.\n\n"
        "RE-ENTRY TRIGGER:\n"
        "- If cash > 40% of portfolio AND regime is BULL_TREND or SIDEWAYS:\n"
        "  You SHOULD deploy cash into highest-conviction opportunities.\n"
